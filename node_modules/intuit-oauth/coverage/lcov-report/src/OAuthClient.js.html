    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">73.69% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>269/365</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>185/289</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>264/353</span>
            </div>
...
<a name='L1097'></a><a href='#L1097'>1097</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3333x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >    if (id_token_payload.iss !== 'https://oauth.platform.intuit.com/op/v1') {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid issuer in ID token');</span>
    }
&nbsp;
    // Step 2 : check if the aud field in idToken contains application's clientId
<span class="cstat-no" title="statement not covered" >    if (!id_token_payload.aud.find(<span class="fstat-no" title="function not covered" >(a</span>udience) =&gt; <span class="cstat-no" title="statement not covered" >audience === this.clientId)</span>) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid audience in ID token');</span>
    }
&nbsp;
    // Step 3 : ensure the timestamp has not elapsed
<span class="cstat-no" title="statement not covered" >    if (id_token_payload.exp &lt; Date.now() / 1000) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('ID token has expired');</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw new Error(`Key with kid "${kid}" not found in JWKS`);</span>
      }
...
OAuthClient.prototype.shouldRetry = function shouldRetry(error, attempt) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (attempt &gt;= OAuthClient.retryConfig.maxRetries) {
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
&nbsp;
  // Check if it's a retryable status code
  <span class="missing-if-branch" title="if path not taken" >I</span>if (error.response &amp;&amp; OAuthClient.retryConfig.retryableStatusCodes.includes(error.response.status)) {
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
  // Check if it's a retryable network error
  <span class="missing-if-branch" title="if path not taken" >I</span>if (error.code &amp;&amp; OAuthClient.retryConfig.retryableErrors.includes(error.code)) {
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
  return false;
...
&nbsp;
  const executeRequest = () =&gt; axios(request)
      ...
      .catch((error) =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.shouldRetry(error, attempt)) {
