...
function renderStubPage(pdfDoc, invoice, fonts, logo) {
  ...
  drawWindowAddressBlock(page, remitLines, RETURN_ENVELOPE9_SPEC.topAddressZone, fonts, panelY);
  drawWindowAddressBlock(page, customerLines, RETURN_ENVELOPE9_SPEC.bottomAddressZone, fonts, panelY);
