...
async function ensureCopilotLiveTables(pool) {
  ...
  await pool.query(`CREATE UNIQUE INDEX IF NOT EXISTS dispatch_route_templates_seed_key_uidx ON dispatch_route_templates(seed_key) WHERE seed_key IS NOT NULL`);
