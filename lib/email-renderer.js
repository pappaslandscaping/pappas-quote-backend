...
function buildServiceAgreementEmailV4({
  ...
  const agreementTotal = Number(total || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
...
<head>
  ...
  <style>
    @media only screen and (max-width:620px) {
      ...
      .summary-column { display:block !important; width:100% !important; padding:0 0 18px !important; }
    }
  </style>
</head>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
            <tr><td class="mobile-pad" style="padding:34px 34px 0;">
              <div style="background:linear-gradient(135deg,#f7f9f5 0%,#edf3e6 100%);border-radius:22px;padding:30px 30px 28px;text-align:left;">
                <div style="font-family:Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:1px;line-height:1.6;text-transform:uppercase;color:#6e7f6d;">Agreement Ready</div>
                <div class="hero-title" style="font-family:Helvetica,Arial,sans-serif;font-size:34px;font-weight:700;line-height:1.08;color:#2e403d;padding:12px 0 16px;max-width:430px;">Your service agreement is ready</div>
                ...
                <div style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:1.8;color:#425466;padding-top:12px;max-width:470px;">Thank you for accepting estimate #${estimate}. Please review and sign your service agreement online using the link below.</div>
              </div>
            </td></tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
                <tr>
                  <td class="summary-column" style="vertical-align:top;width:48%;padding-right:18px;text-align:left;">
                    ...
                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:1.75;color:#425466;padding-top:10px;">A quick look before you review and sign.</div>
                  </td>
            ...
            <tr><td class="mobile-pad" style="padding:28px 28px 4px;">
              <div style="border-top:1px solid #d7dfd1;padding-top:18px;">
                ...
                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1.7;color:#2e403d;padding-bottom:14px;">Review the agreement to make sure the scope of work, terms, and pricing match your accepted estimate.</div>
                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1.7;color:#2e403d;padding-bottom:14px;">Sign the agreement online to complete this step.</div>
                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1.7;color:#2e403d;">Once it is signed, our team can move forward with scheduling your service.</div>
              </div>
            </td></tr>
