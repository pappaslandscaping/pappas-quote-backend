    ...
    <section class="page stub-page">
      <div class="stub-sheet">
        ...
        <div class="stub-panel">
          ...
          <div class="stub-address-window stub-remit-window" aria-label="Remit address for #9 top window">
            ${remitLines.map((line, index) => index === 0
              ? `<strong>${escapeHtml(line)}</strong>`
              : `<div>${escapeHtml(line)}</div>`).join('')}
          </div>

          <div class="stub-address-window stub-customer-window" aria-label="Customer address for #9 bottom window">
          ...
          <div class="stub-side-panel">
            <div class="stub-meta-card">
              <div class="stub-meta-table">
                <div class="stub-meta-row"><span>Customer</span><strong>${escapeHtml(invoice.customer_name || '')}</strong></div>
