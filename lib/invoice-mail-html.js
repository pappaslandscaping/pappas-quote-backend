      ...
      <div class="stub-sheet">
        ...
        <div class="copilot-stub">
          ...
          <div class="stub-balance-card">
            <div class="stub-balance-row"><span>Outstanding Balance</span><strong>${outstandingBalance}</strong></div>
            <div class="stub-balance-row"><span>This Invoice</span><strong>${thisInvoiceAmount}</strong></div>
          </div>
        </div>
      </div>
    </section>
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .copilot-stub {
      display: grid;
      grid-template-columns: 2.5in 1.7in 1.56in;
      gap: 0.28in;
      align-items: end;
      min-height: 2.22in;
    }
    ...
    .stub-balance-row + .stub-balance-row {
