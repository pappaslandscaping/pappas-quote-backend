...
async function discoverInvoicePdf(settings, invoice) {
  ...
  if (customerStanding) {
    ...
    if (customerStanding.past_due_balance !== null) {
      standingMeta.prior_balance = customerStanding.past_due_balance;
      standingMeta.past_due_balance = customerStanding.past_due_balance;
      standingMeta.outstanding_balance = customerStanding.past_due_balance;
    }
    if (customerStanding.outstanding_balance !== null) {
      standingMeta.total_due = customerStanding.outstanding_balance;
      standingMeta.total_due_on_account = customerStanding.outstanding_balance;
    }
