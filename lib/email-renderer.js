...
function buildServiceAgreementEmailV4({
  ...
  const agreementTotal = /^\{[^}]+\}$/.test(totalText)
    ? (String.fromCharCode(36) + escapeEmailHtml(totalText))
    : (String.fromCharCode(36) + Number(totalText.replace(/[$,]/g, '') || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
