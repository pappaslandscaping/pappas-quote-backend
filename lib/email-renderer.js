    ...
    <mjml>
      <mj-head>
        <mj-attributes>
          ...
          <mj-button background-color="#c9dd80" color="#2e403d" font-size="14px" font-weight="700" inner-padding="14px 26px" border-radius="999px" padding="0" />
        </mj-attributes>
        <mj-style inline="inline">
          .email-shell { box-shadow: 0 14px 34px rgba(31, 41, 51, 0.08); }
          .body-text a { color: #2e403d; text-decoration: underline; }
          .btn-primary a { color: #2e403d !important; }
        </mj-style>
      </mj-head>
      <mj-body>
        <mj-wrapper css-class="email-shell" background-color="#ffffff" padding="24px 12px" border-radius="22px">
        ${wrapper === 'full' ? header : ''}
...
function emailTemplate(content, options = {}) {
  ...
  const signatureHtml = showSignature ? `
    <div style="margin-top:28px;padding-top:18px;border-top:1px solid #e4e9e4;">
      ...
      <p style="margin:8px 0 0;font-size:12px;line-height:1.6;color:#6d7a72;font-family:Helvetica,Arial,sans-serif;">Timothy Pappas &bull; Pappas &amp; Co. Landscaping</p>
    </div>
  ` : '';
  ...
  const contentPadding = wrapperMode === 'minimal' ? '30px 34px 28px' : '30px 34px 26px';
  const contentBlock = `
  <tr><td class="mobile-pad" style="padding:${contentPadding};font-family:Helvetica,Arial,sans-serif;color:#425466;font-size:15px;line-height:1.8;">
    ${content}
...
<body style="margin:0;padding:24px;background:#ffffff;font-family:Helvetica,Arial,sans-serif;color:#425466;font-size:15px;line-height:1.8;">
${content}
</body>
</html>`;
  }
  ...
  const featuresSection = showFooterFeatures ? `
      <tr><td class="mobile-pad" style="padding:4px 34px 0;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#f7f9f5 0%,#edf3e6 100%);border-radius:18px;">
          <tr><td style="padding:20px 22px;">
            <p style="text-align:left;font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:#6e7f6d;font-weight:700;margin:0 0 8px;font-family:Helvetica,Arial,sans-serif;">Inside your account</p>
            <p style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:1.25;color:#2e403d;font-weight:700;margin:0 0 18px;">Everything stays organized in one place</p>
              ...
              <tr>
                <td style="padding:12px 0;border-bottom:1px solid #e3e8e2;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    ...
                    <td><strong style="color:#2e403d;font-family:Helvetica,Arial,sans-serif;">Service Schedule</strong><br><span style="color:#6e7f6d;font-size:13px;font-family:Helvetica,Arial,sans-serif;">View upcoming visits and service history</span></td>
                  </tr></table>
                </td>
              </tr>
              <tr>
                <td style="padding:12px 0;border-bottom:1px solid #e3e8e2;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    <td style="width:32px;vertical-align:top;"><span style="font-size:18px;color:#223330;">•</span></td>
                    <td><strong style="color:#2e403d;font-family:Helvetica,Arial,sans-serif;">Easy Payments</strong><br><span style="color:#6e7f6d;font-size:13px;font-family:Helvetica,Arial,sans-serif;">Pay invoices securely online anytime</span></td>
                  </tr></table>
                </td>
              </tr>
              <tr>
                <td style="padding:12px 0;border-bottom:1px solid #e3e8e2;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    <td style="width:32px;vertical-align:top;"><span style="font-size:18px;color:#223330;">•</span></td>
                    <td><strong style="color:#2e403d;font-family:Helvetica,Arial,sans-serif;">Direct Messaging</strong><br><span style="color:#6e7f6d;font-size:13px;font-family:Helvetica,Arial,sans-serif;">Send questions or requests to our team</span></td>
                  </tr></table>
                </td>
              </tr>
              <tr>
                <td style="padding:12px 0;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    <td style="width:32px;vertical-align:top;"><span style="font-size:18px;color:#223330;">•</span></td>
                    <td><strong style="color:#2e403d;font-family:Helvetica,Arial,sans-serif;">Quotes &amp; Invoices</strong><br><span style="color:#6e7f6d;font-size:13px;font-family:Helvetica,Arial,sans-serif;">Access all your documents in one place</span></td>
                  </tr></table>
                </td>
              </tr>
            </table>
  ...
  const headerHtml = `
  <tr><td style="background:#1f2933;padding:18px 28px;border-radius:22px 22px 0 0;text-align:left;">
    <img src="${LOGO_URL}" alt="Pappas & Co. Landscaping" width="210" style="display:block;border:0;outline:none;text-decoration:none;height:auto;width:210px;max-width:100%;">
  </td></tr>`;
...
<style>@media only screen and (max-width:620px){.email-shell{width:100%!important}.mobile-pad{padding-left:22px!important;padding-right:22px!important}.social-cell{display:block!important;text-align:left!important;padding-left:0!important}}</style>
</head>
<body style="margin:0;padding:0;background:#eef2eb;font-family:Helvetica,Arial,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" style="background:#eef2eb;padding:24px 12px;">
<tr><td align="center">
<table class="email-shell" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#ffffff;border-collapse:separate;border-spacing:0;">
  ${headerHtml}
  <tr><td style="background:#ffffff;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;"><table width="100%" cellpadding="0" cellspacing="0">${contentBlock}</table></td></tr>
  <tr><td style="background:#f7f9f5;padding:20px 28px 24px;border:1px solid #e2e8f0;border-top:0;border-radius:0 0 22px 22px;text-align:center;">
    <p style="margin:0;font-size:14px;line-height:1.65;color:#5b6773;font-family:Helvetica,Arial,sans-serif;">Questions? Reply to this email or call <a href="tel:4408867318" style="color:#2e403d;font-weight:700;text-decoration:none;">(440) 886-7318</a>.</p>
    <p style="margin:14px 0 0;font-size:13px;line-height:1.7;color:#5b6773;font-family:Helvetica,Arial,sans-serif;">Pappas &amp; Co. Landscaping<br><a href="https://pappaslandscaping.com" style="color:#5b6773;text-decoration:none;">pappaslandscaping.com</a></p>
  </td></tr>
</table>
</td></tr>
</table>
...
<html>
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<style>@media only screen and (max-width:620px){.email-shell{width:100%!important}.mobile-pad{padding-left:22px!important;padding-right:22px!important}.footer-copy,.social-cell{display:block!important;width:100%!important;text-align:center!important}.social-cell{padding:16px 0 0!important}}</style>
</head>
<body style="margin:0;padding:0;background:#eef2eb;font-family:Helvetica,Arial,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" style="background:#eef2eb;padding:24px 12px;">
<tr><td align="center">
<table class="email-shell" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;border-collapse:separate;border-spacing:0;">
  ${headerHtml}
  <tr><td style="background:#ffffff;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr><td class="mobile-pad" style="padding:0 34px;">
        <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #d7dfd1;">
          <tr><td style="padding:14px 0 13px;text-align:left;">
            <p style="margin:0;font-size:12px;line-height:1.6;color:#5b6773;font-family:Helvetica,Arial,sans-serif;">Reply directly to this email or call <a href="tel:4408867318" style="color:#2e403d;font-weight:700;text-decoration:none;">(440) 886-7318</a> if you need anything from our team.</p>
          </td></tr>
        </table>
      </td></tr>
      ${contentBlock}
  ...
  <tr><td class="mobile-pad" style="background:#f7f9f5;padding:20px 34px 24px;border:1px solid #e2e8f0;border-top:0;border-radius:0 0 22px 22px;">
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td class="footer-copy" style="padding:0;text-align:left;">
              <p style="margin:0 0 6px;font-size:12px;color:#2e403d;font-weight:700;font-family:Helvetica,Arial,sans-serif;">Pappas &amp; Co. Landscaping</p>
              <p style="margin:0 0 6px;font-size:11px;color:#5b6773;font-family:Helvetica,Arial,sans-serif;">Reply here or call <a href="tel:4408867318" style="color:#5b6773;text-decoration:none;">(440) 886-7318</a> &bull; <a href="https://pappaslandscaping.com" style="color:#5b6773;text-decoration:none;">pappaslandscaping.com</a></p>
              <p style="margin:0;font-size:10px;color:#8b97a3;font-family:Helvetica,Arial,sans-serif;"><a href="${baseUrl}/unsubscribe.html?email={unsubscribe_email}" style="color:#6e7f6d;text-decoration:underline;">Unsubscribe</a> from marketing emails</p>
            </td>
            <td class="social-cell" align="right" style="padding:0;vertical-align:top;">
              ...
              <p style="margin:10px 0 0;font-size:10px;color:#8b97a3;font-family:Helvetica,Arial,sans-serif;">Follow along</p>
            </td>
          </tr>
        </table>
  </td></tr>
...
function buildServiceAgreementEmailV4({
  ...
  const currencySymbol = String.fromCharCode(36);
  const agreementTotal = /^\{[^}]+\}$/.test(totalText)
    ? currencySymbol + escapeEmailHtml(totalText)
    : currencySymbol + Number(totalText.replace(/[\$,]/g, '') || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
