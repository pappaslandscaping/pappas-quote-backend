...
const endpoints = [
  ...
  ['GET', '/api/app/ai/tasks'],
  ['GET', '/api/app/ai/end-of-day-briefing'],
  ['POST', '/api/app/ai/analyze-conversation', {}],
  ['POST', '/api/app/ai/analyze-voicemail', {}],
  ['POST', '/api/app/ai/tasks', {}],
  ['PATCH', `/api/app/ai/tasks/${FAKE_ID}`, { status: 'completed' }],
